...
#%%
sc.tl.louvain(adata, resolution=0.5, key_added='louvain_r0.5', random_state=10) #play around with resolution to get the 9 total sub-groups

adata.obs['louvain_r0.5'].value_counts()
#Visualize the clustering and how this is reflected by different technical covariates
sc.pl.umap(adata, color=['louvain_r1', 'louvain_r0.5'], palette=sc.pl.palettes.vega_20) #module 'scanpy.plotting.palettes' has no attribute 'default_64'
...
adata.rename_categories('louvain_r0.5', ['Stem', 'TA', 'Goblet', 'Enterocyte', 'EP (early)', 'Paneth', 'EP (stress)', 'Enteroendocrine', 'Tuft'])
adata.obs['louvain_r0.5'].value_counts() #new categories need to have the same number of items as the old categories!
...
sc.pl.umap(adata, color='louvain_r0.5_entero_sub', palette=sc.pl.palettes.godsnot_102)
...
sc.pl.umap(adata, color='louvain_r0.5_entero_mat_sub', palette=sc.pl.palettes.godsnot_102)
#Get the new marker genes
...
print(robjects.r.ls()) # This should now show you that the andata_ent object was converted over into the r global environment 

#This is what you will need to make non interactive plots
grdevices = importr('grDevices')

#Plot 1
robjects.globalenv['colour_map'] = robjects.r(f'brewer.pal(20,"Set1")')

grdevices.png(file="/home/jake/Documents/SC_RNA_SEQ/file_2.png")
robjects.r('''
...
print(slingshot.SlingshotDataSet(adata_ent_start))
